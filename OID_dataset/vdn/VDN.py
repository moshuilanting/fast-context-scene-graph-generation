...
class resnet_model(nn.Module):
    def __init__(self, block, layers=[2, 2, 2, 2, 2], dataset_name='VG', baseWidth=26, scale=4):
        ...
        self.visual_fc1 = nn.Linear(784, 512)
        ...
        if dataset_name=='PSG':
            ...
            self.visual_fc2 = nn.Linear(512, 31)
...
class visual_rel_model(nn.Module):
    def __init__(self,dataset_name='VG'):
        ...
        self.image_conv = resnet_model(Bottleneck,[3, 4, 6, 3, 2],dataset_name)
