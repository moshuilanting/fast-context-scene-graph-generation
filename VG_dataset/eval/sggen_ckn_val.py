...
# image_file = '/home/jtl/SG_semantic/713/little_data/VG_little'
# val_object_label = '/home/jtl/SG_semantic/713/little_data/object_detection/xywh'
# val_relation_label = '/home/jtl/SG_semantic/713/little_data/relation_detection'


weights = 'ckn/CKN+EPBS.pt'
object_weights = 'yolol_object_test_28.pt'

print(weights,object_weights)
...
if __name__=="__main__":
    ...
    with torch.no_grad():
        for batch_i, (img, targets, relations,paths, shapes, image) in enumerate(tqdm(dataloader, desc=s)):
            ...
            targets[:, 2:] = xywh2xyxy(targets[:, 2:]).to('cpu')
            #obj_pred[:, :4] = xywh2xyxy(obj_pred[:, :4]).to('cpu')
