...
image_file = '/home/jtl/VG_100K/'
train_object_label_dir = 'dataset/VG_object_detection/xyxy/train_val/'
train_relation_label_dir = 'dataset/VG_relation_detection/train_val/'
test_object_label_dir = 'dataset/VG_object_detection/xyxy/test/'
test_object_yolo_label_dir = 'dataset/VG_object_detection/xywh/test/'
test_relation_label_dir = 'dataset/VG_relation_detection/test/'
